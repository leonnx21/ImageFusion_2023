...
class Encoder0(nn.Module):
    def __init__(self):
        ...
        # encoder
        self.conv1 = ConvLayer(1, nb_filter[0], kernel_size, stride)
...
class EncoderIF(nn.Module):
    def __init__(self):
        ...
        self.layers.add_module('ConvIF2', nn.Conv2d(1, 32, 3, 1 , 1))
...
class EncoderVIS(nn.Module):
    def __init__(self):
        ...
        self.layers = nn.Sequential()
        self.layers.add_module('ConvVI2', nn.Conv2d(1, 32, 3, 1 , 1))
        ...
        self.layers.add_module('ConvVI5', nn.Conv2d(128, 64, 3, 1, 1))
...
class Fusion_method(nn.Module):
    ...
    def max(self, x, y ):
        out1 = torch.maximum(x, y)
        # out2 = torch.maximum(x, z)
        # out3 = torch.maximum(out1, out2)
        return out1
...
#         self.layers.add_module('ConvD5', nn.Conv2d(16,1,3,1,1))

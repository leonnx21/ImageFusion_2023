...
class args():
	...
	save_model_dir = "Original_model/models/" #"path to folder where trained model will be saved."
	save_loss_dir = "Original_model/models/loss/"  # "path to folder where trained model will be saved."

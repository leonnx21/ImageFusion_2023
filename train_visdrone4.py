...
if __name__ == '__main__':
    ...
    train_path = './Trained/CBD4/trained_model/'
    writer_path = './Trained/CBD4/stats/'
    name = 'CBD4'
    ...
    if training_new == True:
        ...
        checkpoint = torch.load("Trained/CBD4/trained_model/all_train/model_train_20231002_002542_118")

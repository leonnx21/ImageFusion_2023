import torch
from model_visdrone8 import Fusionmodel
...
if __name__ == '__main__':
    ...
    # training_loader = loader_function( '/storage/locnx/COCO2014/', '1000files', '1000files', batchsize=batchsize, num_samples=100)
    # validation_loader = loader_function('/storage/locnx/COCO2014/', '100vals', '100vals', batchsize=batchsize, num_samples=50)
    ...
    train_path = './Trained/CBD8/trained_model/'
    writer_path = './Trained/CBD8/stats/'
    name = 'CBD8'

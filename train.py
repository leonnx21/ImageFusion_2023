...
from utils import mkdir, gradient, hist_similar, view_img, CustomVisionDataset
import os
import time
...
def train():
    save_name = "Training_"
    train_path = './train_newmodel_result/'
    epochs = 20
    batch_size = 2
    ...
    dataset = CustomVisionDataset('/storage/locnx/samplevisdrone')

...
class Encoder1(nn.Module):
    def __init__(self):
        ...
        self.layers.add_module('ConvIF2', nn.Conv2d(3, 32, 3, 1 , 1, padding_mode='replicate'))
        self.layers.add_module('MaxpoolIF2', nn.MaxPool2d(3, stride=1, padding=1))
        self.layers.add_module('ActIF2' , nn.ReLU())
        self.layers.add_module('ConvIF3', nn.Conv2d(32, 64, 3, 1, 1, padding_mode='replicate'))
...
class Fusion_method(nn.Module):
    ...
    def forward(self, vis1, vis2, ir1, ir2):
        out = self.No_mix_func(vis1, vis2, ir1, ir2)
        return out
...
class Decoder0(nn.Module):
    def __init__(self):
        ...
        self.layers = nn.Sequential()
        self.layers.add_module('ConvD2', nn.Conv2d(256,128,3,1,1))
